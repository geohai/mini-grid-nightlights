...
did_control_agg_plt <- ggdid(did_control_agg, xgap = 6) +
    labs(title = "Average Treatment Effect (ATT) of Mini-Grid Construction on Nighttime Brightness for Sierra Leone Mini-Grid Sites", x = "Months Since Commissioning", y = "Change in Brightness") +
    theme_bw() +
...
# export as a figure for thesis
ggsave("figures/dark_sl/did_minigrid_vs_control_v3.png", did_notyettreated_agg_plt, width = 12, height = 6, units = "in", dpi = 600)
