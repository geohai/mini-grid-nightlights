...
did_control_agg_plt <- ggdid(did_control_agg, xgap = 6) +
    labs(title = "Average Effect of Mini-Grid Construction on Nighttime Brightness for Sierra Leone Mini-Grid Sites", x = "Months Since Commissioning", y = "Change in Brightness") +
    theme_bw() +
