...
```{r}
# read in data
tree_df <- read_csv("./data/dark_sl/nighttime_trees_melt_df.csv")
water_df <- read_csv("./data/dark_sl/nighttime_water_melt_df.csv")
glimpse(tree_df)
...
# export df to csv
write_csv(dark_df, "./data/dark_sl/dark_df.csv")
```

## Data Cleaning
```{r}
# read in data
dark_df <- read_csv("./data/dark_sl/dark_df.csv")
...
# export df to csv
write_csv(dark_df, "./data/dark_sl/dark_df_clean.csv")
...
```{r}
# read in data
df <- read_csv("./data/dark_sl/dark_df_clean.csv")
...
# export df to csv
# View(df)
write_csv(df, "./data/dark_sl/dark_df_for_csdind.csv")
```
...
dark_df <- read_csv("./data/dark_sl/dark_df_for_csdind.csv")
...
# export df to csv
write_csv(df, "./data/dark_sl/dark_df_plus_grids_for_csdind.csv")
```

## Visualize the Data Before Modeling
```{r}
# read in the data
df <- read_csv("./data/dark_sl/dark_df_plus_grids_for_csdind.csv")
...
# export df to csv
write_csv(df, "./data/dark_sl/dark_df_plus_grids_for_csdind_years.csv")
```

## Rerun the DinD Analysis with Years as Time Periods
```{r}
# read in the data
df <- read_csv("./data/dark_sl/dark_df_plus_grids_for_csdind_years.csv")
