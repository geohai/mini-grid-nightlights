...
df <- df %>%
    filter(type == "mini-grid" | type == "built")
...
did_control_agg_plt <- ggdid(did_control_agg, xgap = 6) +
    labs(title = "ATT of Mini-Grid Commissioning on Nighttime Brightness for Mini-Grid Sites vs. Built-Up Areas", x = "Months Since Commissioning", y = "Change in Brightness") +
    theme_bw() +
...
ggsave("figures/dark_sl/did_minigrid_vs_built_serif.png", did_control_agg_plt, width = 16, height = 8, units = "in", dpi = 300)
