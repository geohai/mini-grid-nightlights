...
use_plot_pres <- night_use %>%
  ...
  scale_x_log10() +
  scale_y_log10() +
  labs(title = "Nighttime Brightness 24-Month SMA vs. Total Consumption",
...
acpu_plot <- night_use %>%
  ...
  scale_x_log10() +
  scale_y_log10() +
  labs(title = "Nighttime Brightness 24-Month SMA vs. ACPU",
       x = "Nighttime Brightness (nW/cm^2/sr)",
...
rev_plot <- night_use %>%
  ...
  scale_x_log10() +
  scale_y_log10() +
  labs(title = "Nighttime Brightness 24-Month SMA vs. Total Revenue",
       x = "Nighttime Brightness (nW/cm^2/sr)",
       y = "Total Revenue (USD)") +
   theme_bw() +
   theme(text = element_text(family = "serif", size = 20), legend.position = "none")
...
cust_plot <- night_use %>%
  ...
  scale_x_log10() +
  scale_y_log10() +
  labs(title = "Nighttime Brightness 24-Month SMA vs. # of Customers",
       x = "Nighttime Brightness (nW/cm^2/sr)",
