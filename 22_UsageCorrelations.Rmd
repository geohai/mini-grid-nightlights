...
acpu_plot <- night_use %>%
  ...
  labs(title = "Relationship Between Nighttime Brightness and ACPU",
   ...
   theme(text = element_text(family = "serif", size = 20), legend.position = "right")
acpu_plot
ggsave("figures/usage/acpu_scatterplot.png", acpu_plot, width = 12, height = 6, units = "in", dpi = 300)
...
rev_plot <- night_use %>%
  ...
  labs(title = "Relationship Between Nighttime Brightness and Total Revenue",
   ...
   theme(text = element_text(family = "serif", size = 20), legend.position = "right")
rev_plot
ggsave("figures/usage/rev_scatterplot.png", rev_plot, width = 12, height = 6, units = "in", dpi = 300)
...
cust_plot <- night_use %>%
  ...
  labs(title = "Relationship Between Nighttime Brightness and # of Customers",
   ...
   theme(text = element_text(family = "serif", size = 20), legend.position = "right")
cust_plot
ggsave("figures/usage/cust_scatterplot.png", cust_plot, width = 12, height = 6, units = "in", dpi = 300)
```
