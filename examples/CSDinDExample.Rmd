...
```{r}
original_file_name <- "data/sl/nightlight_values_for_csdind.csv"
clean_monthly_file_name <- "data/sl/nightlight_values_for_csdind_nonames.csv"
clean_yearly_file_name <- "data/sl/nightlight_values_for_csdind_years.csv"
```
